...
public class LabirintoBuilderTest {
	...
	public void testLabirintoConStanzaBloccata_ConPassepartout() {
		...
		assertEquals(stanzaVincente,labirintoBuilder.getListaStanze().get("stanza bloccata").getStanzaAdiacente(Direzioni.NORD));	
	}
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		assertEquals(stanzaBloccata,labirintoBuilder.getListaStanze().get("stanza bloccata").getStanzaAdiacente(Direzioni.NORD));
	}
	...
	public void testaddStanzaMagica() {
		Labirinto labirintoCompleto = this.labirintoBuilder
				...
				.addStanzaVincente(nomeStanzaVincente)
				.addStanza("corridoio")
				.addStanzaMagica("stanza magica").getLabirinto();
		StanzaMagica controllo=(StanzaMagica) labirintoBuilder.getListaStanze().get("stanza magica");
		assertEquals(3, controllo.getsogliamagica());
	}
	@Test 
	public void testcrastanzeconadiacenza() {
		Labirinto labirintoCompleto = this.labirintoBuilder
				.addStanzaIniziale(nomeStanzaIniziale)
				.addStanzaVincente(nomeStanzaVincente)
				.addAdiacenza("salotto", "salagiochi", "nord")
				.getLabirinto(); 
		assertTrue(labirintoBuilder.getListaStanze().containsKey("salotto"));
		assertTrue(labirintoBuilder.getListaStanze().containsKey("salagiochi"));
	}
